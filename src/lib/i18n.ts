...
const dict: Record<string, { en: string; ko: string }> = {
  ...
  'footer.support': { en: 'Support', ko: '지원' },
  'footer.terms': { en: 'Terms', ko: '이용약관' },
  'footer.attribution': { en: 'Data provided by Strava', ko: 'Strava 데이터 제공' },
  'footer.rights': { en: 'All rights reserved.', ko: '모든 권리 보유.' },
  'support.title': { en: 'Support', ko: '고객 지원' },
  'support.sub': { en: 'We\'re here to help. Reach out anytime.', ko: '언제든지 문의해 주세요.' },
  'support.contactTitle': { en: 'Contact Us', ko: '문의하기' },
  'support.contactDesc': { en: 'Email us and we\'ll get back to you within 24 hours.', ko: '이메일을 보내주시면 24시간 내 답변 드립니다.' },
  'support.email': { en: 'Email Support', ko: '이메일 문의' },
  'support.faqTitle': { en: 'Frequently Asked Questions', ko: '자주 묻는 질문' },
  'support.q1': { en: 'What Strava data does RunDNA access?', ko: 'RunDNA는 어떤 Strava 데이터를 사용하나요?' },
  'support.a1': { en: 'RunDNA reads your running activities (distance, pace, duration, heart rate, elevation) and basic profile info (name, photo, city). We request read-only access — we cannot post, modify, or delete any Strava data.', ko: 'RunDNA는 러닝 활동(거리, 페이스, 시간, 심박수, 고도)과 기본 프로필(이름, 사진, 도시)을 읽습니다. 읽기 전용 권한만 요청하며 Strava 데이터를 게시·수정·삭제할 수 없습니다.' },
  'support.q2': { en: 'How do I disconnect my Strava account?', ko: 'Strava 계정 연결을 해제하려면?' },
  'support.a2': { en: 'Go to Strava → Settings → My Apps, find RunDNA and click Revoke Access. You can also contact us to delete all your data.', ko: 'Strava → 설정 → 내 앱으로 이동 후 RunDNA를 찾아 액세스 취소를 클릭하세요. 데이터 삭제를 원하시면 저희에게 연락해 주세요.' },
  'support.q3': { en: 'Is my data shared with anyone?', ko: '내 데이터가 공유되나요?' },
  'support.a3': { en: 'No. Your running data is never sold or shared with third parties. It is only sent to our AI provider to generate your coaching responses.', ko: '아니요. 러닝 데이터는 제3자와 공유되거나 판매되지 않습니다. AI 코칭 응답 생성을 위해서만 AI 제공업체로 전송됩니다.' },
  'support.q4': { en: 'How do I delete my RunDNA account?', ko: 'RunDNA 계정을 삭제하려면?' },
  'support.a4': { en: 'Email us at skypeople41@gmail.com with the subject "Delete my account" and we will remove all your data within 30 days.', ko: 'skypeople41@gmail.com으로 "계정 삭제" 제목으로 이메일을 보내주시면 30일 이내에 모든 데이터를 삭제합니다.' },
  'support.q5': { en: 'Why does RunDNA need my Strava authorization?', ko: 'RunDNA가 Strava 권한을 필요로 하는 이유는?' },
  'support.a5': { en: 'RunDNA uses the Strava API to analyze your training history and generate personalized AI coaching, DNA analysis, and race plans. Without activity data, we cannot provide these features.', ko: 'RunDNA는 Strava API를 통해 훈련 기록을 분석하고 AI 코칭, DNA 분석, 레이스 플랜을 제공합니다. 활동 데이터 없이는 이 기능들을 제공할 수 없습니다.' },
  'support.strava': { en: 'Strava Access', ko: 'Strava 접근 관리' },
  'support.stravaDesc': { en: 'Manage or revoke RunDNA\'s access to your Strava account directly from Strava settings.', ko: 'Strava 설정에서 직접 RunDNA의 Strava 접근 권한을 관리하거나 취소할 수 있습니다.' },
  'support.stravaBtn': { en: 'Manage on Strava', ko: 'Strava에서 관리' },
